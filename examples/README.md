...
- **[Complementary](./complementary.ipynb)** — demonstrates the use of the Complementary SHAP explainer with text data. It shows some internal matrixes for validation of the method.
- **[Neyman](./neyman.ipynb)** — showcases the Neyman-Shapley explainer with text data. It shows some internal matrixes for validation of the method.
- **[Hierarchical](./hierarchical.ipynb)** — illustrates the Hierarchical SHAP explainer applied to text data.
